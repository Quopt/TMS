<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebUserControlCustomerReportProjectRevenue.ascx.cs" Inherits="TMS_Recycling.WebUserControlCustomerReportProjectRevenue" %>
...
<td>
    <asp:Label ID="LabelDetailType" runat="server" Text="Klantproject"></asp:Label>
</td>
<td>
...
<td>
    ...
    <asp:RadioButtonList ID="RadioButtonListCustomerSelection" runat="server" 
        AutoPostBack="True" 
        onselectedindexchanged="RadioButtonListCustomerSelection_SelectedIndexChanged">
...
<td>
    <asp:RadioButtonList ID="RadioButtonListShowCat" runat="server" 
        ...
        Enabled="False">
        <asp:ListItem Value="All" Selected="True">Alle projecten</asp:ListItem>
        <asp:ListItem Value="Specific" >Alleen onderstaand project</asp:ListItem>
    </asp:RadioButtonList>
    <cc11:ClassComboBox ID="ComboBoxCustomerProjectSelection" runat="server" 
        AutoCompleteMode="SuggestAppend" DataSourceID="EntityDataSourceCustomerProject" 
        DataTextField="Description" DataValueField="Description" DropDownStyle="DropDownList" 
        MaxLength="0" style="display: inline;" Enabled="False">
    </cc11:ClassComboBox>
</td>
<td>
...
<td>
    <asp:RadioButtonList ID="RadioButtonListOrderStatus" runat="server">
        ...
        <asp:ListItem Value="OpenInvoices" >Openstaande facturen</asp:ListItem>
        <asp:ListItem Value="ClosedInvoices" >Betaalde facturen</asp:ListItem>
        <asp:ListItem Value="AllInvoices" >Betaalde & onbetaalde facturen</asp:ListItem>
    </asp:RadioButtonList>
</td>
<td>
...
<td align="right">
 ...
 <table width="100%" class="resultspanel"><tr><td>
   <iframe id="FrameShowReport" scrolling="auto" runat="server" height="400px" width="100%">
     ...
     <cc11:classentitydatasource ID="EntityDataSourceCustomerProject" runat="server" 
         ConnectionString="name=ModelTMSContainer" 
         DefaultContainerName="ModelTMSContainer" 
         EntitySetName="RelationProjectSet" OrderBy="it.Description" Select="it.[Description], it.[Id]" 
         Where="it.Relation.Id = @RelationId">
         <WhereParameters>
             <asp:ControlParameter ControlID="ComboBoxCustomerSelection" 
                 DefaultValue="00000000-0000-0000-0000-000000000000" Name="RelationId" 
