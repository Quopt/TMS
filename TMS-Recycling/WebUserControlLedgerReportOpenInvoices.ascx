<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebUserControlLedgerReportOpenInvoices.ascx.cs" Inherits="TMS_Recycling.WebUserControlLedgerReportOpenInvoices" %>
...
<td>
    <asp:Label ID="LabelInvoiceType" runat="server" Text="Soort facturen"></asp:Label>
    </td>
<td>
...
<td>
    ...
    <asp:RadioButtonList ID="RBListSelectedInvoiceType" runat="server">
        <asp:ListItem Selected="True" Value="">Alle facturen</asp:ListItem>
        <asp:ListItem Value="Buy">Inkoopfacturen</asp:ListItem>
        <asp:ListItem Value="Sell">Verkoopfacturen</asp:ListItem>
        <asp:ListItem Value="Rent">Verhuurfacturen</asp:ListItem>
        <asp:ListItem Value="BuyLedger">Losse inkoopfacturen</asp:ListItem>
        <asp:ListItem Value="SellLedger">Losse verkoopfacturen</asp:ListItem>
    </asp:RadioButtonList>
</td>
<td>

    <asp:RadioButtonList ID="RBListSelectedInvoiceStatus" runat="server">
        <asp:ListItem Value="">Alle facturen</asp:ListItem>
        <asp:ListItem Selected="True" Value="Open">Openstaande facturen</asp:ListItem>
        <asp:ListItem Value="Paid">Betaalde facturen</asp:ListItem>
    </asp:RadioButtonList>
    </td>
<td>
