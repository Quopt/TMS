<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebUserControlNonCashPurchase.ascx.cs" Inherits="TMS_Recycling.WebUserControlNonCashPurchase" %>
...
<asp:Label ID="LabelBasicData" runat="server" Text="Basisgegevens order" CssClass="SubMenuHeader"></asp:Label>
    <table style="width: 100%;">
        <tr>
            ...
            <td>
                <cc11:ClassComboBox ID="DropDownListLocations" runat="server" 
                    ...
                    onselectedindexchanged="DropDownListLocations_SelectedIndexChanged1" AutoPostBack="True">
                </cc11:ClassComboBox>
            </td>
        ...
        <tr>
            ...
            <td  style="width:150px;">
                <uc3:URLPopUpControl ID="URLPopUpControlNewCustomerProject" runat="server" 
                    ...
                    URLToPopup="WebFormPopUp.aspx?uc=CustomerRelationOverview" 
                    OnPopUpClosed="URLPopUpControlNewCustomerProject_OnPopupClosed" />
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td width="250px">
                <uc3:URLPopUpControl ID="URLPopUpControlNewCustomerLocation" runat="server" 
                    ...
                    URLToPopup="WebFormPopUp.aspx?uc=CustomerRelationOverview" 
                    OnPopUpClosed="URLPopUpControlNewCustomerLocation_OnPopupClosed" />
            </td>
        </tr>
        <tr>
            <td>
...
<tr>
<td>
 <asp:Label ID="LabelOrderRemark" runat="server" Text="Order opmerkingen"></asp:Label>
</td>
<td colspan="3">
    <asp:TextBox ID="TextBoxOrderRemark" runat="server" Width="90%" MaxLength="1000" TextMode="MultiLine"></asp:TextBox>
</td>
</tr>

<tr>
<td colspan="4">
    <asp:CheckBox ID="CheckBoxGoodsHaveBeenDelivered" runat="server" 
        Text="Goederen zijn reeds geleverd. Bij verwerken worden deze goederen in/uit het magazijn geplaatst." />
    <asp:CheckBox ID="CheckBoxDeterminePriceDuringInvoice" runat="server" 
        Text="Bepaal prijs en gewichten tijdens factureren" AutoPostBack="True" 
        oncheckedchanged="CheckBoxDeterminePriceDuringInvoice_CheckedChanged"  />
</td>
</tr>
</table>
</asp:Panel>
...
<asp:Button ID="ButtonNewOrder" runat="server" Text="Nieuwe order" 
    onclick="ButtonNewOrder_Click" /><br />
...
<asp:Label ID="LabelGeneratedOrderId" runat="server" 
...
WHERE (it.IsActive) and (it.Relation.Id = @CustID) and (it.AgreementType = @InvoiceType) and (CurrentDateTime() between it.StartDateTime and it.EndDateTime  ) 
    ...
    DefaultContainerName="ModelTMSContainer" EntityTypeFilter="" Select="">
    <CommandParameters>
