<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebUserControlCustomerRelationLocationOverview.ascx.cs" Inherits="TMS_Recycling.WebUserControlRelationLocationOverview" %>
