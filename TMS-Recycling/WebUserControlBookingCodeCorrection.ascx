<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebUserControlBookingCodeCorrection.ascx.cs" Inherits="TMS_Recycling.WebUserControlBookingCodeCorrection" %>
<%@ Register assembly="TMS-Recycling" namespace="TMS_Recycling" tagprefix="cc11" %>

<asp:Label ID="Label1" runat="server" Text="Stand boekingscode correctie "></asp:Label><asp:Label
