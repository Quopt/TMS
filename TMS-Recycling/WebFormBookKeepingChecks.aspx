<%@ Page Title="" Language="C#" MasterPageFile="~/SiteBookkeeping.master" AutoEventWireup="true" CodeBehind="WebFormBookKeepingChecks.aspx.cs" Inherits="TMS_Recycling.WebFormBookKeepingChecks" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderPathLink" runat="server">
   <span class="Header2"><asp:Label ID="LabelPath" runat="server" Text="Boekhouding \ Kasboeken \ Controles"></asp:Label></span>
</asp:Content>
