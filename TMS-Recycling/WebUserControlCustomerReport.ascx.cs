...
{
    public partial class WebUserControlCustomerReport : System.Web.UI.UserControl
    {
        ...
        protected void ButtonShowReport_Click(object sender, EventArgs e)
        {
            ...
            // load up the iframe 
            URL = "WebFormPopup.aspx?UC=ShowReport&d=DataSetRelation&r=ReportRelation&AdressType=" + ComboBoxAdressType.SelectedValue;
            LabelURL.Text = URL;
