<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebUserControlCustomerReportLabels.ascx.cs" Inherits="TMS_Recycling.WebUserControlCustomerReportLabels" %>
